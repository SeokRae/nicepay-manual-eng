...
> #### ⚠️ Important  
> Key-in requires your merchant account to be specifically enabled for manual-entry payments by NicePay. See the [Key-in Payment](./api/nicepay-api-keyin.md) doc's Important note before planning around it.
