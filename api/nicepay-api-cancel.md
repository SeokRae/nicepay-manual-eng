...
<a href="../image/payment-checkout-cancel-cycle.svg"><img alt="Sequence diagram of the full card and easy-pay cycle: checkout (steps 1-7), then the cancellation this page covers (steps 8-9, marked Cancellation)" src="../image/payment-checkout-cancel-cycle.svg" width="800px"></a>
